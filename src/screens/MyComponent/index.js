...
export default class MyComponent extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            pendingRoom: (Math.floor(Math.random() * 1000 * 100)).toString(),
            messages: [],
            notifications: [],
            draft: '',
            address: null,
    ...
    setupSocketListeners() {
        ...
        this.socket.on('ROOM_JOINED', newRoom => {
            this.currentRoom = newRoom.toString();
            this.addNotification(
        ...
        this.socket.on('ROOM_FULL', () => {
            this.addNotification(
                `Cannot Join ${this.state.pendingRoom.toString()}, Zentaroom is full`
            );
            this.state.pendingRoom = Math.floor(Math.random() * 1000 * 10).toString();
            this.joinRoom();
        });
